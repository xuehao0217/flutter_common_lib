...
bannerEntityEntityFromJson(BannerEntity data, Map<String, dynamic> json) {
	if (json['data'] != null) {
		data.data = (json['data'] as List).map((v) => BannerEntityData().fromJson(v)).toList();
	}
...
Map<String, dynamic> bannerEntityEntityToJson(BannerEntity entity) {
...
bannerEntityDataFromJson(BannerEntityData data, Map<String, dynamic> json) {
	if (json['desc'] != null) {
