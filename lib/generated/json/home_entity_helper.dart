...
homeEntityFromJson(HomeEntity data, Map<String, dynamic> json) {
	...
	if (json['datas'] != null) {
		data.datas = (json['datas'] as List).map((v) => HomeDatas().fromJson(v)).toList();
	}
	if (json['offset'] != null) {
...
homeDatasFromJson(HomeDatas data, Map<String, dynamic> json) {
...
Map<String, dynamic> homeDatasToJson(HomeDatas entity) {
	final Map<String, dynamic> data = new Map<String, dynamic>();
